d3 = function () {
    ...
    function j(n) {
        var t = "selectstart." + n, e = "dragstart." + n, r = "click." + n, i = va.select(xa).on(t, g).on(e, g), u = Ma.style, a = u[Ya];
        return u[Ya] = "none", function (n) {
            function o() {
                i.on(r, null)
            }
    ...
    function ot(n, t, e) {
        ...
        var r = nt((.4124564 * n + .3575761 * t + .1804375 * e) / no), i = nt((.2126729 * n + .7151522 * t + .072175 * e) / to), u = nt((.0193339 * n + .119192 * t + .9503041 * e) / eo);
    ...
    function gt(n, t, e, r) {
        ...
        return !xa.XDomainRequest || "withCredentials"in c || !/^(http(s)?:)?\/\//.test(n) || (c = new XDomainRequest), "onload"in c ? c.onload = c.onerror = i : c.onreadystatechange = function () {
            ...
            if (2 === arguments.length && "function" == typeof r && (i = r, r = null), c.open(e, n, !0), null == t || "accept"in o || (o.accept = t + ",*/*"), c.setRequestHeader)for (var a in o)c.setRequestHeader(a, o[a]);
    ...
    function Ft() {
        function n(n, i) {
            n *= Ja;
            var u = Math.cos(i *= Ja), a = u * Math.cos(n), o = u * Math.sin(n), c = Math.sin(i), l = Math.atan2(Math.sqrt((l = e * c - r * o) * l + (l = r * a - t * c) * l + (l = t * o - e * a) * l), t * a + e * o + r * c);
    ...
    function Ot() {
        function n(n, t) {
            n *= Ja;
            var e = Math.cos(t *= Ja), a = e * Math.cos(n), o = e * Math.sin(n), c = Math.sin(t), l = i * c - u * o, f = u * a - r * c, s = r * o - i * a, h = Math.sqrt(l * l + f * f + s * s), g = r * a + i * o + u * c, p = h && -Y(g) / h, d = Math.atan2(h, g);
    ...
    function It(n, t, e, r) {
        return function (i) {
            ...
            var h, g, p, d = t(i), m = {
                point: u, lineStart: o, lineEnd: c, polygonStart: function () {
        ...
        for (var l = 0, f = t.length; f > l; ++l) {
            ...
            if (h) {
                for (var g = s[0], p = g[0], d = g[1] / 2 + Ba / 4, m = Math.sin(d), v = Math.cos(d), y = 1; ;) {
                    y === h && (y = 0), n = s[y];
                    var M = n[0], x = n[1] / 2 + Ba / 4, b = Math.sin(x), _ = Math.cos(x), w = M - p, S = Math.abs(w) > Ba, E = m * b;
    ...
    function $t(n) {
        ...
        return {
            lineStart: function () {
                ...
                var o = u > 0 ? Ba : -Ba, c = Math.abs(u - e);
    ...
    function Jt(n, t, e, r) {
        var i;
        if (null == n)i = e * Ba / 2, r.point(-Ba, i), r.point(0, i), r.point(Ba, i), r.point(Ba, 0), r.point(Ba, -i), r.point(0, -i), r.point(-Ba, -i), r.point(-Ba, 0), r.point(-Ba, i); else if (Math.abs(n[0] - t[0]) > $a) {
    ...
    function Kt(n) {
        ...
        function e(n) {
            ...
            return {
                lineStart: function () {
                    ...
                    var g, p = [s, h], d = t(s, h), m = o ? d ? 0 : i(s, h) : d ? i(s + (0 > s ? Ba : -Ba), h) : 0;
                    if (!e && (c = a = d) && n.lineStart(), d !== a && (g = r(e, p), (jt(e, g) || jt(p, g)) && (p[0] += $a, p[1] += $a, d = t(p[0], p[1]))), d !== a)f = 0, d ? (n.lineStart(), g = r(p, e), n.point(g[0], g[1])) : (g = r(e, p), n.point(g[0], g[1]), n.lineEnd()), e = g; else if (l && e && o ^ d) {
                        var v;
        ...
        function r(n, t, e) {
            ...
            if (!(0 > M)) {
                ...
                w > S && (_ = w, w = S, S = _);
                var A = S - w, N = Math.abs(A - Ba) < $a, q = N || $a > A;
        ...
        var a = Math.cos(n), o = a > 0, c = [n, 0], l = Math.abs(a) > $a, f = we(n, 6 * Ja);
        return It(t, e, f, u)
    }
    ...
    function Qt(n, t, e, r) {
        ...
        return function (c) {
            ...
            var y, M, x, b, _, w, S, E, k, A, N = c, q = Xt(), T = {
                point: p,
                lineStart: d,
                lineEnd: m,
    ...
    function ge(n) {
        ...
        function e(t, u, a, o, c, l, f, s, h, g, p, d, m, v) {
            var y = f - t, M = s - u, x = y * y + M * M;
            if (x > 4 * r && m--) {
                var b = o + g, _ = c + p, w = l + d, S = Math.sqrt(b * b + _ * _ + w * w), E = Math.asin(w /= S), k = Math.abs(Math.abs(w) - 1) < $a ? (a + h) / 2 : Math.atan2(_, b), A = n(k, E), N = A[0], q = A[1], T = N - t, C = q - u, z = M * T - y * C;
                (z * z / x > r || Math.abs((y * T + M * C) / x - .5) > .3 || i > o * g + c * p + l * d) && (e(t, u, a, o, c, l, N, q, k, b /= S, _ /= S, w, m, v), v.point(N, q), e(N, q, k, b, _, w, f, s, h, g, p, d, m, v))
            }
        }

        var r = .5, i = Math.cos(30 * Ja), u = 16;
    ...
    function me(n) {
        ...
        }), h = 150, g = 480, p = 250, d = 0, m = 0, v = 0, y = 0, M = 0, x = Po, b = st, _ = null, w = null;
    ...
    function Te() {
        function n(n, i) {
            var u = Math.sin(i *= Ja), a = Math.cos(i), o = Math.abs((n *= Ja) - t), c = Math.cos(o);
    ...
    function lr(n, t) {
        var e = {
            ...
            bisect: function (n, t) {
                ...
                return s && "l" === u.side || !s && "r" === u.side ? null : {x: o, y: c}
    ...
    function _r(n, t) {
        ...
        for (o < t.length && l.push(t.substring(o)), r = 0, u = f.length; (e = lc.exec(n)) && u > r; ++r)if (a = f[r], a.x == e[0]) {
            if (a.i)if (null == l[a.i + 1])for (l[a.i - 1] += a.x, l.splice(a.i, 1), i = r + 1; u > i; ++i)f[i].i--; else for (l[a.i - 1] += a.x + l[a.i + 1], l.splice(a.i, 2), i = r + 1; u > i; ++i)f[i].i -= 2; else if (null == l[a.i + 1])l[a.i] = a.x; else for (l[a.i] = a.x + l[a.i + 1], l.splice(a.i + 1, 1), i = r + 1; u > i; ++i)f[i].i--;
            f.splice(r, 1), u--, r--
    ...
    function Hr(n, t) {
        var e;
        return arguments.length < 2 && (t = .45), arguments.length ? e = t / (2 * Ba) * Math.asin(1 / n) : (n = 1, e = t / 4), function (r) {
    ...
    function nu(n, t, e, r, i) {
        ...
        return u.invert = function (t) {
            ...
            return n.domain(Vi(i, e === tu ? {floor: r, ceil: a} : {
                floor: function (n) {
                    return -a(-n)
                }, ceil: function (n) {
                    return -r(-n)
    ...
    function xu(n) {
        return function () {
            var t = n.apply(this, arguments), e = t[0], r = t[1] + Sc;
    ...
    function ca(n, t, e) {
        ...
        return r.invert = function (t) {
            ...
            if ("function" != typeof e) {
                var a = u[1] - u[0], o = a / e, c = va.bisect(cl, o);
    ...
    va.ascending = function (n, t) {
        ...
        if (1 === arguments.length)for (; ++u < i;)isNaN(e = +n[u]) || (r += e); else for (; ++u < i;)isNaN(e = +t.call(n, n[u], u)) || (r += e);
        return r
    }, va.mean = function (t, e) {
        var r, i = t.length, u = 0, a = -1, o = 0;
        if (1 === arguments.length)for (; ++a < i;)n(r = t[a]) && (u += (r - u) / ++o); else for (; ++a < i;)n(r = e.call(t, t[a], a)) && (u += (r - u) / ++o);
        return o ? u : void 0
    ...
    va.bisectLeft = Sa.left, va.bisect = va.bisectRight = Sa.right, va.shuffle = function (n) {
        ...
        for (var n = -1, e = va.min(arguments, t), r = new Array(e); ++n < e;)for (var i, u = -1, a = r[n] = new Array(i); ++u < i;)a[u] = arguments[u][n];
        return r
    ...
    var Aa = ["webkit", "ms", "moz", "Moz", "o", "O"], Na = l;
    try {
    ...
    var Ca = /[\\\^\$\*\+\?\|\[\]\(\)\.\{\}]/g, za = function (n, t) {
        return t.querySelector(n)
    }, Da = function (n, t) {
        return t.querySelectorAll(n)
    }, ja = Ma[o(Ma, "matchesSelector")], La = function (n, t) {
        return ja.call(n, t)
    };
    ...
    va.ns = {
        ...
        if (arguments.length < 2) {
            if ("string" == typeof n) {
                ...
                } else for (t = e.getAttribute("class"); ++i < r;)if (!b(n[i]).test(t))return !1;
                return !0
            }
        ...
        function e(n, e) {
            var r, u, a, o = n.length, s = e.length, h = Math.min(o, s), g = new Array(s), p = new Array(s), d = new Array(o);
            if (t) {
    ...
    va.selection.enter = T, va.selection.enter.prototype = Pa, Pa.append = Ha.append, Pa.insert = Ha.insert, Pa.empty = Ha.empty, Pa.node = Ha.node, Pa.call = Ha.call, Pa.size = Ha.size, Pa.select = function (n) {
        ...
        var n, t, e = Ac || ++Cc, r = [], i = Object.create(zc);
        i.time = Date.now();
    ...
    va.touches = function (n, t) {
        ...
        function t() {
            ...
            function t() {
                ...
                var t = n(), e = t[0] - f[0], r = t[1] - f[1];
                s |= e | r, f = t, o({type: "drag", x: t[0] + u[0], y: t[1] + u[1], dx: e, dy: r})
            }

            function i() {
                g.on(null != l ? "touchmove.drag-" + l : "mousemove.drag", null).on(null != l ? "touchend.drag-" + l : "mouseup.drag", null), h(s && va.event.target === c), o({type: "dragend"})
            }

            var u, a = this, o = e.of(a, arguments), c = va.event.target, l = va.event.touches ? va.event.changedTouches[0].identifier : null, f = n(), s = 0, h = j(null != l ? "drag-" + l : "drag"), g = va.select(xa).on(null != l ? "touchmove.drag-" + l : "mousemove.drag", t).on(null != l ? "touchend.drag-" + l : "mouseup.drag", i, !0);
            r ? (u = r.apply(a, arguments), u = [u.x - f[0], u.y - f[1]]) : u = [0, 0], o({type: "dragstart"})
        }

        var e = d(n, "drag", "dragstart", "dragend"), r = null;
        ...
        function a(n) {
            u(), va.event.preventDefault(), n({type: "zoom", scale: w, translate: _})
        }
        ...
        function o() {
            ...
            var r = this, u = E.of(r, arguments), o = va.event.target, c = 0, l = va.select(xa).on("mousemove.zoom", n).on("mouseup.zoom", e), f = t(va.mouse(r)), s = j("zoom")
        }
        ...
        function f() {
            var n = va.mouse(this), e = t(n), u = Math.log(w) / Math.LN2;
        ...
        function h() {
            var n = va.touches(this), t = n[0], e = g[t.identifier];
            if (u = n[1]) {
                var u, o = g[u.identifier], c = va.event.scale;
                if (null == c) {
        ...
        var g, p, m, v, y, M, x, b, _ = [0, 0], w = 1, S = Va, E = d(n, "zoom");
    ...
    var Ia, Va = [0, 1 / 0], Xa = "onwheel"in ya ? (Ia = function () {
    ...
    var Ba = Math.PI, $a = 1e-6, Wa = $a * $a, Ja = Ba / 180, Ga = 180 / Ba;
    ...
    var Qa = 18, no = .95047, to = 1, eo = 1.08883, ro = J.prototype = new H;
        ...
        return e.parse = function (n, t) {
            ...
            function e() {
                ...
                for (; c > f;) {
                    ...
                    if (10 === r)i = !0; else if (13 === r)i = !0, 10 === n.charCodeAt(f) && (++f, ++o); else if (r !== l)continue;
    ...
    var fo = xa[o(xa, "requestAnimationFrame")] || function (n) {
            setTimeout(n, 17)
        }, so = ".", ho = ",", go = [3, 3], po = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"].map(yt);
    va.formatPrefix = function (n, t) {
        ...
        var t = mo.exec(n), e = t[1] || " ", r = t[2] || ">", i = t[3] || "", u = t[4] || "", a = t[5], o = +t[6], c = t[7], l = t[8], f = t[9], s = 1, h = "", g = !1;
    ...
    va.geo.bounds = function () {
        ...
        function t(t, e) {
            ...
            if (v) {
                ...
                zt(a), a = Dt(a);
                var c = t - p, l = c > 0 ? 1 : -1, d = a[0] * Ga * l, m = Math.abs(c) > 180;
                if (m ^ (d > l * p && l * t > d)) {
                    var y = a[1] * Ga;
                    y > g && (g = y)
        ...
        return function (n) {
            ...
            return M = x = null, 1 / 0 === f || 1 / 0 === s ? [[0 / 0, 0 / 0], [0 / 0, 0 / 0]] : [[f, s], [h, g]]
        }
    }(), va.geo.centroid = function (n) {
        ko = Ao = No = qo = To = Co = zo = Do = jo = Lo = Ho = 0, va.geo.stream(n, Fo);
        var t = jo, e = Lo, r = Ho, i = t * t + e * e + r * r;
    ...
    }, Po = It(Rt, $t, Jt, Gt), Oo = [-Ba, 0], Ro = 1e9;
    (va.geo.conicEqualArea = function () {
        ...
        var t, e, r, i, u = va.geo.albers(), a = va.geo.conicEqualArea().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]), o = va.geo.conicEqualArea().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]), c = {
            point: function (n, e) {
                t = [n, e]
            }
        };
        return n.invert = function (n) {
            ...
            return e = u.translate(t).clipExtent([[f - .455 * l, s - .238 * l], [f + .455 * l, s + .238 * l]]).stream(c).point, r = a.translate([f - .307 * l, s + .201 * l]).clipExtent([[f - .425 * l + $a, s + .12 * l + $a], [f - .214 * l - $a, s + .234 * l - $a]]).stream(c).point, i = o.translate([f - .205 * l, s + .212 * l]).clipExtent([[f - .214 * l + $a, s + .166 * l + $a], [f - .115 * l - $a, s + .234 * l - $a]]).stream(c).point, n
        }, n.scale(1070)
    };
    ...
    }, $o = {point: ue, lineStart: f, lineEnd: f, polygonStart: f, polygonEnd: f}, Wo = {
        point: ce,
        lineStart: le,
        lineEnd: fe,
        polygonStart: function () {
    ...
    va.geo.path = function () {
        ...
        return n.area = function (n) {
            ...
            return Xo = Zo = -(Io = Vo = 1 / 0), va.geo.stream(n, i($o)), [[Io, Vo], [Xo, Zo]]
        ...
        function n() {
            var n = "function" == typeof r ? r.apply(this, arguments) : r, t = Me(-n[0] * Ja, -n[1] * Ja, 0).invert, i = [];
        ...
        var e, r = (t[0] - n[0]) * Ja, i = n[1] * Ja, u = t[1] * Ja, a = Math.sin(r), o = Math.cos(r), c = Math.sin(i), l = Math.cos(i), f = Math.sin(u), s = Math.cos(u);
        ...
        }, n.majorExtent([[-180, -90 + $a], [180, 90 - $a]]).minorExtent([[-180, -80 - $a], [180, 80 + $a]])
    ...
    var ic = [0, 2 / 3, 1 / 3, 0], uc = [0, 1 / 3, 2 / 3, 0], ac = [0, 1 / 6, 2 / 3, 1 / 6];
    va.geom.hull = function (n) {
        ...
        function t(n) {
            ...
            if (c === Pe && l === Oe)t = n; else for (t = new Array(f), a = 0; f > a; ++a)t[a] = [+c.call(this, u = n[a], a), +l.call(this, u, a)];
            if (lr(t, function (n) {
                    var t, e, r, i, u, a;
        ...
        return arguments.length ? t(n) : (t.x = function (n) {
            ...
            if (null == n)i = null; else {
                ...
                i = va.geom.polygon([[e, r], [e, a], [u, a], [u, r]])
            }
            return t
        }, t.size = function (n) {
            ...
            if (c === Pe && l === Oe)t = n; else for (t = new Array(f), u = 0; f > u; ++u)t[u] = [+c.call(this, i = n[u], u), +l.call(this, i, u)];
    ...
    var fc = function () {
        ...
        linear: fc, poly: zr, quad: function () {
            return qr
        }, cubic: function () {
            return Tr
        }, sin: function () {
        ...
        "in": st, out: Ar, "in-out": Nr, "out-in": function (n) {
            return Nr(Ar(n))
        }
    });
    va.ease = function (n) {
        ...
        var e, r, i, u, a, o = {}, c = va.dispatch("start", "tick", "end"), l = [1, 1], f = .9, s = gc, h = pc, g = -30, p = .1, d = .8, m = [], v = [];
    ...
    va.layout.histogram = function () {
        ...
        function t(e) {
            var u = e.children;
            if (u && u.length) {
                var a, o, c, l = s(e), f = [], h = u.slice(), p = 1 / 0, d = "slice" === g ? l.dx : "dice" === g ? l.dy : "slice-dice" === g ? 1 & e.depth ? l.dy : l.dx : Math.min(l.dx, l.dy);
    ...
    va.scale.quantile = function () {
        ...
        function n() {
            var n = t.apply(this, arguments), u = e.apply(this, arguments), a = r.apply(this, arguments) + Sc, o = i.apply(this, arguments) + Sc, c = (a > o && (c = a, a = o, o = c), o - a), l = Ba > c ? "0" : "1", f = Math.cos(a), s = Math.sin(a), h = Math.cos(o), g = Math.sin(o);
        ...
        return n.innerRadius = function (e) {
            ...
            var n = (t.apply(this, arguments) + e.apply(this, arguments)) / 2, u = (r.apply(this, arguments) + i.apply(this, arguments)) / 2 + Sc;
            return [Math.cos(u) * n, Math.sin(u) * n]
        }, n
    };
    var Sc = -Ba / 2, Ec = 2 * Ba - 1e-6;
    va.svg.line.radial = function () {
        ...
        function t(n, t, e, r) {
            var i = t.call(n, e, r), u = o.call(n, i, r), a = c.call(n, i, r) + Sc, f = l.call(n, i, r) + Sc;
        ...
        function n(n, i) {
            var u = t.call(this, n, i), a = e.call(this, n, i), o = (u.y + a.y) / 2, c = [u, {x: u.x, y: o}, {
                x: a.x,
                y: o
            }, a];
    ...
    var kc = va.map({
        circle: wu, cross: function (n) {
            var t = Math.sqrt(n / 5) / 2;
            return "M" + -3 * t + "," + -t + "H" + -t + "V" + -3 * t + "H" + t + "V" + -t + "H" + 3 * t + "V" + t + "H" + t + "V" + 3 * t + "H" + -t + "V" + t + "H" + -3 * t + "Z"
        }, diamond: function (n) {
            var t = Math.sqrt(n / (2 * qc)), e = t * qc;
            return "M0," + -t + "L" + e + ",0" + " 0," + t + " " + -e + ",0" + "Z"
        }, square: function (n) {
            var t = Math.sqrt(n) / 2;
            return "M" + -t + "," + -t + "L" + t + "," + -t + " " + t + "," + t + " " + -t + "," + t + "Z"
        }, "triangle-down": function (n) {
            var t = Math.sqrt(n / Nc), e = t * Nc / 2;
    ...
    var Ac, Nc = Math.sqrt(3), qc = Math.tan(30 * Ja), Tc = [], Cc = 0, zc = {ease: Cr, delay: 0, duration: 250};
    Tc.call = Ha.call, Tc.empty = Ha.empty, Tc.node = Ha.node, Tc.size = Ha.size, va.transition = function (n) {
        ...
        var t, e = va.scale.linear(), r = Dc, i = 6, u = 6, a = 6, o = 3, c = [10], l = null, f = 0;
    ...
    var Dc = "bottom", jc = {top: 1, right: 1, bottom: 1, left: 1};
    va.svg.brush = function () {
        function n(u) {
            u.each(function () {
                var u, a = va.select(this), f = a.selectAll(".background").data([0]), s = a.selectAll(".extent").data([0]), h = a.selectAll(".resize").data(l, String);
        ...
        function i() {
            ...
            function d(n, t, e) {
                var r, i, a = Ui(t), o = a[0], c = a[1], l = N[e], h = f[1][e] - f[0][e];
            ...
            function m() {
                p(), _.style("pointer-events", "all").selectAll(".resize").style("display", n.empty() ? "none" : null), va.select("body").style("cursor", null), q.on("mousemove.brush", null).on("mouseup.brush", null).on("touchmove.brush", null).on("touchend.brush", null).on("keydown.brush", null).on("keyup.brush", null), A(), b({type: "brushend"})
            }

            var v, y, M = this, x = va.select(va.event.target), b = a.of(M, arguments), _ = va.select(M), w = x.datum(), S = !/^(n|s)$/.test(w) && o, E = !/^(e|w)$/.test(w) && c, k = x.classed("extent"), A = j("brush"), N = i(), q = va.select(xa).on("keydown.brush", l).on("keyup.brush", h);
            if (va.event.changedTouches ? q.on("touchmove.brush", p).on("touchend.brush", m) : q.on("mousemove.brush", p).on("mouseup.brush", m), k)N[0] = f[0][0] - N[0], N[1] = f[0][1] - N[1]; else if (w) {
                var T = +/w$/.test(w), C = +/^n/.test(w);
                y = [f[1 - T][0] - N[0], f[1 - C][1] - N[1]], N[0] = f[T][0], N[1] = f[C][1]
            } else va.event.altKey && (v = N.slice());
            _.style("pointer-events", "none").selectAll(".resize").style("display", null), va.select("body").style("cursor", x.style("cursor")), b({type: "brushstart"}), p()
        }

        var u, a = d(n, "brushstart", "brush", "brushend"), o = null, c = null, l = Hc[0], f = [[0, 0], [0, 0]], s = [!0, !0];
    ...
    va.time = {};
    var Fc = Date, Pc = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"];
    Cu.prototype = {
        getDate: function () {
    ...
    var Oc = Date.prototype, Rc = "%a %b %e %X %Y", Yc = "%m/%d/%Y", Uc = "%H:%M:%S", Ic = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], Vc = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"], Xc = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], Zc = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"];
    ...
    var Bc = Lu(Ic), $c = Hu(Ic), Wc = Lu(Vc), Jc = Hu(Vc), Gc = Lu(Xc), Kc = Hu(Xc), Qc = Lu(Zc), nl = Hu(Zc), tl = /^%/, el = {
        "-": "",
        _: " ",
        0: "0"
    }, rl = {
        ...
        }, c: va.time.format(Rc), d: function (n, t) {
        ...
        }, x: va.time.format(Yc), X: va.time.format(Uc), y: function (n, t) {
    ...
    var gl = ll.map(function (n) {
        return [n[0].utc, n[1]]
    }), pl = [[va.time.format.utc("%Y"), Rt], [va.time.format.utc("%B"), function (n) {
