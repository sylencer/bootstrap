(function () {
                ...
                for (i = _i = 0, _ref = this.options.ykeys.length; 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++_i : --_i) {
                    ...
                    coords = (function () {
                        ...
                        for (_j = 0, _len = _ref2.length; _j < _len; _j++) {
                            r = _ref2[_j];
                            if (r._y[i] !== void 0) {
                                _results1.push({x: r._x, y: r._y[i]});
                            }
                        }
                        return _results1;
                    }).call(this);
    ...
    minutesSpecHelper = function (interval) {
        return {
            span: interval * 60 * 1000, start: function (d) {
    ...
    secondsSpecHelper = function (interval) {
        return {
            span: interval * 1000, start: function (d) {
    ...
    Morris.LABEL_SPECS = {
        "decade": {
            span: 172800000000, start: function (d) {
        ...
        "year": {
            span: 17280000000, start: function (d) {
        ...
        "month": {
            span: 2419200000, start: function (d) {
        ...
        "week": {
            span: 604800000, start: function (d) {
        ...
        "day": {
            span: 86400000, start: function (d) {
                return new Date(d.getFullYear(), d.getMonth(), d.getDate());
            }, fmt: function (d) {
                return "" + (d.getFullYear()) + "-" + (Morris.pad2(d.getMonth() + 1)) + "-" + (Morris.pad2(d.getDate()));
            }, incr: function (d) {
